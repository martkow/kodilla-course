...
import com.kodilla.kodilla.good.patterns2.facade.api.ItemDto;
import com.kodilla.kodilla.good.patterns2.facade.api.OrderDto;
import com.kodilla.kodilla.good.patterns2.facade.api.OrderFacade;
import com.kodilla.kodilla.good.patterns2.facade.api.OrderProcessingException;
...
class ShopServiceTest {
    ...
    // Compare this use of our API with the previous one (the previous test case). We can now refactor the internal API without "showing off" to the external users of our facade – we will simply adjust the internal implementation of the facade to the ongoing changes in the internal API. Externally, the facade will remain transparent, readable, and unchanged.
}
